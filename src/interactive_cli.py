...
class ThreatoraConsole(cmd2.Cmd):
            ...
            if r.status_code == 200:
                ...
                if not silent:
                    ...
                    console.print(
                        ...
                        f"Model: {data.get('model_architecture', 'Threatora Temporal Transformer World Model')} │ "
    ...
    def do_dashboard(self, _args):
        ...
        engine_txt = (
            ...
            f"[bold cyan]World Model      :[/bold cyan] [bold white]{health_data.get('model_architecture', 'Threatora Temporal Transformer World Model')}[/bold white]\n"
            f"[bold cyan]Feature Dimension:[/bold cyan] [bold white]{health_data.get('obs_dimension', 16)} Telemetry Features[/bold white]\n"
