...
def run_evaluation_benchmark(
    ...
    data_file = Path(data_path) if data_path else default_val
    ...
    if clf is None:
        ...
        train_pq = default_train if default_train.exists() else repo_root / "data" / "processed" / "train_windows.parquet"
        if train_pq.exists():
